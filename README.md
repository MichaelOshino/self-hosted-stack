...
1. **Клонируйте репозиторий**:
   ...
   ```
2. **SSL-сертификаты**:  
   **Изначально имеется самоподписанный сертификат. Его можно оставить ТОЛЬКО для локальных тестов, НЕ ИСПОЛЬЗУЕТСЯ ЕГО ЕСЛИ СЕРВИСЫ БУДУТ ВО ВНЕШНЕЙ СЕТИ РАБОТАТЬ!**
